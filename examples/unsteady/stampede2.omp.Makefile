...
compileFlags = -Wall -Wextra -Wnon-virtual-dtor -Wno-deprecated-declarations -DPLB_MAC_OS_X -std=gnu99 -D_OPENMP -qopenmp -qopt-report5 -qopt-report-phase=vec -qopenmp-simd # ${TACC_VEC_FLAGS} -fno-strict-aliasing
